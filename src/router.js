...

        {
            ...
            children: [{
                ...
                },
                {
                    ...
                    name: 'Game',
                    component: () =>
                        import ( /* webpackChunkName: "geme" */ './views/Game.vue')
                },
                {
                    path: 'calendar',
                    name: 'Calendar',
                ...
                },
                {
                    ...
                    name: 'CalendarDetail',
                    component: () =>
                        import ( /* webpackChunkName: "calendar-detail" */ './views/CalendarDetail.vue')
                },
                {
                    path: 'user',
                    name: 'User',
                ...
                },
                {
                    ...
                    name: 'AnimeDetail',
                    component: () =>
                        import ( /* webpackChunkName: "anime-detail" */ './views/AnimeDetail.vue')
                },
                {
                    path: 'anime-edit/:id',
                    name: 'AnimeEdit',
                    component: () =>
                        import ( /* webpackChunkName: "anime-edit" */ './views/AnimeEdit.vue')
                },
                {
                    path: 'anime-add',
                    name: 'AnimeAdd',
                    component: () =>
                        import ( /* webpackChunkName: "anime-add" */ './views/AnimeAdd.vue')
                },

                {
                    ...
                    name: 'GameDetail',
                    component: () =>
                        import ( /* webpackChunkName: "game-detail" */ './views/GameDetail.vue')
                },
                {
                    path: 'game-edit/:id',
                    name: 'GameEdit',
                    component: () =>
                        import ( /* webpackChunkName: "game-edit" */ './views/GameEdit.vue')
                },
                {
                    path: 'game-add',
                    name: 'GameAdd',
